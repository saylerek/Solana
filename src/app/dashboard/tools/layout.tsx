...
const toolLinks = [
  { href: "/dashboard/tools/solana-flow", label: "Solana Flow" },
  { href: "/dashboard/tools/find-bundlers", label: "Find Bundlers" },
  { href: "/dashboard/tools/rescan", label: "Rescan" },
  { href: "/dashboard/tools/mixer", label: "Mixer" },
];
