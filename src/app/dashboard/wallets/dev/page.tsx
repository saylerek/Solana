...
export default function WalletsDevPage() {
  ...
  const [walletCategory, setWalletCategory] = useState("DEV");
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-[#1a1929] p-6 rounded-xl shadow-lg w-96">
            <h2 className="text-lg font-bold mb-4 text-white">Create Dev Wallet</h2>
